...
- **Live Result Display** — Shows "You win", "You lose", or "Tie" after each round
- **Round Recap** — Displays both your pick and the computer's pick after every round
...
3. The result is displayed along with both choices
